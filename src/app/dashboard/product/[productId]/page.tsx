...
import { productFormInfoContent } from '@/config/infoconfig';
...
export default async function Page(props: PageProps) {
  ...
  return (
    <PageContainer
      ...
      pageDescription={
        isNew
          ? 'Add the product, then attach images, options, and variants.'
          : 'Update catalog details, pricing, and inventory.'
      }
      infoContent={productFormInfoContent}
    >
